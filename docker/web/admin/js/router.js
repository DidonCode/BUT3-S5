...
const routes = {
	...
	"/web/admin/accueil": { title: "Accueil", page: "/web/admin/page/accueil.php" },
    "/web/admin/titre": { title: "Accueil", page: "/web/admin/page/titre.php" },
    "/web/admin/playlist": { title: "Accueil", page: "/web/admin/page/playlist.php" },
    "/web/admin/utilisateur": { title: "Accueil", page: "/web/admin/page/utilisateur.php" },
    "/web/admin/permission": { title: "Accueil", page: "/web/admin/page/permission.php" },
}

function routeError(error){
    const route = routes[parseInt(error["error_code"])];

    fetch(route.page).then(response => response.text())
    .then(data => {
