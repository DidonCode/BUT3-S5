		...
		*/
		static function edit($user, $pseudo, $email, $password, $image, $public, $banner){
			...
			try{
				...
				if(isset($image)) {
					if($user['image'] != "/storage/user/profile/default.png") unlink(Settings::$HOST_NAME.$user['image']);
					...
					$imageFilePath = Settings::$HOST_NAME."/storage/user/profile/".$user['id'].".".$imageFileExtension;
				...
				if(isset($banner)) {
					if($user['banner'] != "/storage/user/banner/default.png") unlink(Settings::$HOST_NAME.$user['banner']);
					...
					$bannerFilePath = Settings::$HOST_NAME."/storage/user/banner/".$user['id'].".".$bannerFileExtension;
